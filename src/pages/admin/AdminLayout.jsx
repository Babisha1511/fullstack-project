    ...
    <div className="flex min-h-screen bg-black">
      ...
      <aside className="w-64 bg-black text-white flex flex-col">
        ...
        <nav className="flex-1 p-4 space-y-2">
          ...
          <NavLink to="trainers" className={linkStyle}>Trainer Management</NavLink>
          <NavLink to="clients" className={linkStyle}>Client Management</NavLink>
          <NavLink to="membership" className={linkStyle}>Membership & Renewal</NavLink>
          <NavLink to="reports" className={linkStyle}>Reports</NavLink>
          <NavLink to="store" className={linkStyle}>Store & Payments</NavLink>
          <NavLink to="equipments" className={linkStyle}>Equipments</NavLink>
